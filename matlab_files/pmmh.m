%% ------------------------------------------------------------------------
% pmmh.m: particle marginal metropolis hastings (PMMH)
...
function [draws_thet,draws_X,rej_prct,varargout] = pmmh(pr_fcnHandle,lik_fcnHandle,...
...
% -------------------------------------------------------------------------
    function [acc_prob] = accPr(thet_last,thet_star,lik_star,lik_last)
        ...
        pr_ratio   = prF(thet_star)/prF(thet_last);
        prop_ratio = propPrF(thet_last,thet_star)/propPrF(thet_star,thet_last);
